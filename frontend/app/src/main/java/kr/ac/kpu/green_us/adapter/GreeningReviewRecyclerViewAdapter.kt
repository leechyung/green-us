...
class GreeningReviewRecyclerViewAdapter(private var greeningReview: List<Review> = emptyList()) :
    RecyclerView.Adapter<GreeningReviewRecyclerViewAdapter.MyViewHolder>() {
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int,
    ): GreeningReviewRecyclerViewAdapter.MyViewHolder {
        val cardView = LayoutInflater.from(parent.context)
            .inflate(R.layout.cardview_review_recycler_view, parent, false)
